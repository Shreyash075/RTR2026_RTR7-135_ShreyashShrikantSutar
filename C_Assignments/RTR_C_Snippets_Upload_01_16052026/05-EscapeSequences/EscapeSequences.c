...
int main(void)
{
	...
	printf("\'This is A Single Quoted Output\' Done Uing \\\' \\\' Escape Sequence\n\n");
	printf("BACKSPACE Turned To BACKSRACE\b Using Escape Sequence \\b\n\n");
	...
	printf("Demonstrating \x41 Using \\xhh Escape Sequence\n\n"); //0x41 Is The Hexadecimal Code Fpr Letter 'A'. 'xhh' Is The Place-holder For 'x' Followed By 2 digits (hh), altogether forming a Hexdecimal Number
	printf("Demonstrating \102 Using \\ooo Escape Sequence\n\n"); //102 Is The Octal Code For Letter 'B'. 'ooo' Is The Place-hlder For 3 Digits Forming An Octal Number.
